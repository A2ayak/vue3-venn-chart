...
import {
	defineComponent as Bi,
	useCssVars as Lo,
	ref as $n,
	computed as Fo,
	watch as Oo,
	onMounted as zo,
	getCurrentInstance as Do,
	onUnmounted as qo,
	openBlock as Ho,
	createElementBlock as Xo,
	pushScopeId as Bo,
	popScopeId as Vo,
	createElementVNode as Uo
} from 'vue'
function Vi(t, n) {
...
En.prototype = Ui.prototype = {
	...
	on: function (t, n) {
		...
		if (arguments.length < 2) {
			for (; ++s < o; )
				if ((i = (t = r[s]).type) && (i = Zo(e[i], t.name))) return i
			return
		}
		if (n != null && typeof n != 'function')
			throw new Error('invalid callback: ' + n)
		for (; ++s < o; )
			if ((i = (t = r[s]).type)) e[i] = Fr(e[i], t.name, n)
			else if (n == null) for (i in e) e[i] = Fr(e[i], t.name, null)
		return this
	},
	copy: function () {
		var t = {},
...
var jt = 0.7,
	...
	W = '\\s*([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)%\\s*',
	Jo = /^#([0-9a-f]{3,8})$/,
	Qo = new RegExp('^rgb\\(' + [yt, yt, yt] + '\\)$'),
	jo = new RegExp('^rgb\\(' + [W, W, W] + '\\)$'),
	ta = new RegExp('^rgba\\(' + [yt, yt, yt, tn] + '\\)$'),
	na = new RegExp('^rgba\\(' + [W, W, W, tn] + '\\)$'),
	ea = new RegExp('^hsl\\(' + [tn, W, W] + '\\)$'),
	ra = new RegExp('^hsla\\(' + [tn, W, W, tn] + '\\)$'),
	Or = {
		aliceblue: 15792383,
...
function nn(t) {
	...
	return (
		...
		(n = Jo.exec(t))
			...
			? bn(n[1], n[2], n[3], n[4])
			: (n = na.exec(t))
			? bn((n[1] * 255) / 100, (n[2] * 255) / 100, (n[3] * 255) / 100, n[4])
			: (n = ea.exec(t))
...
function Gi(t) {
	...
	if ((t instanceof pn || (t = nn(t)), !t)) return new U()
...
const Vr = (function t(n) {
	var e = fa(n)
	function r(i, s) {
		var o = e((i = Oe(i)).r, (s = Oe(s)).r),
			a = e(i.g, s.g),
			u = e(i.b, s.b),
			f = Ki(i.opacity, s.opacity)
		return function (l) {
			return (
...
function ha(t, n) {
	var e = (ze.lastIndex = $e.lastIndex = 0),
		r,
		i,
		s,
		o = -1,
...
function da(t) {
	return t === 'none'
		...
		: (It ||
				...
				(Yr = document.defaultView)),
		  (It.style.transform = t),
		  (t = Yr.getComputedStyle(be.appendChild(It), null).getPropertyValue(
				'transform'
		  )),
		  be.removeChild(It),
		  (t = t.slice(7, -1).split(',')),
		  Zi(+t[0], +t[1], +t[2], +t[3], +t[4], +t[5]))
}
function pa(t) {
	return t == null ||
		...
		? De
		: ((t = t.matrix), Zi(t.a, t.b, t.c, t.d, t.e, t.f))
}
function Ji(t, n, e, r) {
	function i(f) {
	...
	function o(f, l, c, h) {
		f !== l
			? (f - l > 180 ? (l += 360) : l - f > 180 && (f += 360),
			  h.push({ i: c.push(i(c) + 'rotate(', null, r) - 2, x: st(f, l) }))
			: l && c.push(i(c) + 'rotate(' + l + r)
	}
	function a(f, l, c, h) {
		f !== l
			? h.push({ i: c.push(i(c) + 'skewX(', null, r) - 2, x: st(f, l) })
...
function re(t) {
	...
	return (
		...
		Gr.hasOwnProperty(n) ? { space: Gr[n], local: t } : t
	)
}
function ya(t) {
	return function () {
		var n = this.ownerDocument,
			e = this.namespaceURI
		return e === qe && n.documentElement.namespaceURI === qe
			? n.createElement(t)
...
function Ma(t, n, e, r, i, s, o) {
	...
	for (a = 0; a < l; ++a)
		(u = n[a]) &&
			((h[a] = d = Wr + o.call(u, u.__data__, a, n)),
			d in f ? (i[a] = u) : (f[d] = u))
	for (a = 0; a < c; ++a)
		(d = Wr + o.call(t, s[a], a, s)),
			(u = f[d])
...
function Sa(t) {
	for (
		...
		for (
			var u = n[a], f = e[a], l = u.length, c = (o[a] = new Array(l)), h, d = 0;
			d < l;
			++d
		)
			(h = u[d] || f[d]) && (c[d] = h)
...
function Ja(t, n, e) {
	return arguments.length > 1
		? this.each(
				(n == null ? Wa : typeof n == 'function' ? Za : Ka)(t, n, e ?? '')
		  )
		: bt(this.node(), t)
}
function bt(t, n) {
	return (
		...
		es(t).getComputedStyle(t, null).getPropertyValue(n)
	)
}
function Qa(t) {
	return function () {
...
function nu(t, n) {
	return arguments.length > 1
		? this.each((n == null ? Qa : typeof n == 'function' ? tu : ja)(t, n))
		: this.node()[t]
}
function rs(t) {
...
function ss(t, n) {
	for (var e = xr(t), r = -1, i = n.length; ++r < i; ) e.add(n[r])
}
function os(t, n) {
	for (var e = xr(t), r = -1, i = n.length; ++r < i; ) e.remove(n[r])
}
function eu(t) {
	return function () {
		ss(this, t)
...
function fu(t) {
	return arguments.length
		? this.each(t == null ? ou : (typeof t == 'function' ? uu : au)(t))
...
function du(t) {
	return arguments.length
		? this.each(t == null ? lu : (typeof t == 'function' ? hu : cu)(t))
		: this.node().innerHTML
}
function pu() {
...
function mu(t, n) {
	var e = typeof t == 'function' ? t : Qi(t),
		r = n == null ? vu : typeof n == 'function' ? n : gr(n)
	return this.select(function () {
...
if (typeof document < 'u') {
	...
	'onmouseenter' in Mu ||
		(as = { mouseenter: 'mouseover', mouseleave: 'mouseout' })
}
function Ru(t, n, e) {
	return (
		(t = us(t, n, e)),
...
Xn.prototype = hs.prototype = {
	...
	restart: function (t, n, e) {
		...
		;(e = (e == null ? se() : +e) + (n == null ? 0 : +n)),
			!this._next &&
				Ut !== this &&
				(Ut ? (Ut._next = this) : (qn = this), (Ut = this)),
			(this._call = t),
			(this._time = e),
			He()
	},
...
function He(t) {
	if (!Nt) {
		...
		var n = t - ft
		n > 24
			? (t < 1 / 0 && (Vt = setTimeout(Kr, t - en.now() - ie)),
			  Pt && (Pt = clearInterval(Pt)))
			: (Pt || ((Hn = en.now()), (Pt = setInterval(Du, ls))), (Nt = 1), cs(Kr))
	}
}
function Zr(t, n, e) {
	var r = new Xn()
...
var Hu = Ui('start', 'end', 'cancel', 'interrupt'),
	Xu = [],
	ds = 0,
	Jr = 1,
	Xe = 2,
...
function yr(t, n) {
	var e = X(t, n)
	if (e.state > ds) throw new Error('too late; already scheduled')
	return e
}
function et(t, n) {
	var e = X(t, n)
...
function Bu(t, n, e) {
	...
	function o(f) {
		var l, c, h, d
		if (e.state !== Jr) return u()
		for (l in r)
			if (((d = r[l]), d.name === e.name)) {
				if (d.state === kn) return Zr(o)
				d.state === Qr
					? ((d.state = Sn),
					  d.timer.stop(),
		...
		if (
			(Zr(function () {
				e.state === kn &&
					((e.state = Qr), e.timer.restart(a, e.delay, e.time), a(f))
			}),
			(e.state = Xe),
		...
		for (
			var l =
					f < e.duration
						...
						: (e.timer.restart(u), (e.state = Be), 1),
				c = -1,
				h = i.length;
			++c < h;
...
function nf(t, n) {
	...
	return this.attrTween(
		t,
		typeof n == 'function'
			? (e.local ? tf : ju)(e, r, _r(this, 'attr.' + t, n))
			: n == null
			? (e.local ? Zu : Ku)(e)
			: (e.local ? Qu : Ju)(e, r, n)
	)
...
function lf(t) {
	var n = this._id
	return arguments.length
		? this.each((typeof t == 'function' ? uf : ff)(n, t))
		: X(this.node(), n).delay
}
function cf(t, n) {
	return function () {
...
function df(t) {
	var n = this._id
	return arguments.length
		? this.each((typeof t == 'function' ? cf : hf)(n, t))
...
function Mf(t, n) {
	...
	return function () {
		var s = bt(this, t),
			o = (this.style.removeProperty(t), bt(this, t))
...
function Ef(t, n, e) {
	...
	return function () {
		var o = bt(this, t),
			...
			u = a + ''
		return (
			a == null && (u = a = (this.style.removeProperty(t), bt(this, t))),
...
function kf(t, n) {
	...
	return function () {
		var u = et(this, t),
			f = u.on,
			l = u.value[s] == null ? a || (a = gs(n)) : void 0
...
function Sf(t, n, e) {
	...
	return n == null
		? this.styleTween(t, Mf(t, r)).on('end.style.' + t, gs(t))
		: typeof n == 'function'
		? this.styleTween(t, Ef(t, r, _r(this, 'style.' + t, n))).each(
				kf(this._id, t)
		  )
		: this.styleTween(t, Rf(t, r, n), e).on('end.style.' + t, null)
}
function Tf(t, n, e) {
	return function (r) {
...
function Uf(t, n) {
	for (var e; !(e = t.__transition) || !(e = e[n]); )
		if (!(t = t.parentNode)) return (Ve.time = se()), Ve
	return e
}
function Yf(t) {
	var n, e
	t instanceof j
		? ((n = t._id), (t = t._name))
		: ((n = xs()), ((e = Ve).time = se()), (t = t == null ? null : t + ''))
...
var rn = 0.7,
	...
	K = '\\s*([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)%\\s*',
	Gf = /^#([0-9a-f]{3,8})$/,
	Wf = new RegExp('^rgb\\(' + [_t, _t, _t] + '\\)$'),
	Kf = new RegExp('^rgb\\(' + [K, K, K] + '\\)$'),
	Zf = new RegExp('^rgba\\(' + [_t, _t, _t, sn] + '\\)$'),
	Jf = new RegExp('^rgba\\(' + [K, K, K, sn] + '\\)$'),
	Qf = new RegExp('^hsl\\(' + [sn, K, K] + '\\)$'),
	jf = new RegExp('^hsla\\(' + [sn, K, K, sn] + '\\)$'),
	ti = {
		aliceblue: 15792383,
		antiquewhite: 16444375,
		aqua: 65535,
...
function on(t) {
	...
	return (
		...
		(n = Gf.exec(t))
			...
			: (n = Qf.exec(t))
			? oi(n[1], n[2] / 100, n[3] / 100, 1)
			: (n = jf.exec(t))
			? oi(n[1], n[2] / 100, n[3] / 100, n[4])
			: ti.hasOwnProperty(t)
			? ri(ti[t])
			: t === 'transparent'
			? new L(NaN, NaN, NaN, 0)
...
vr(
	...
	_s(xn, {
		brighter: function (t) {
			return (
				(t = t == null ? Vn : Math.pow(Vn, t)),
				new L(this.r * t, this.g * t, this.b * t, this.opacity)
			)
		},
		darker: function (t) {
			return (
				(t = t == null ? rn : Math.pow(rn, t)),
				new L(this.r * t, this.g * t, this.b * t, this.opacity)
			)
		},
		rgb: function () {
...
function vs(t) {
	...
	if ((t instanceof xn || (t = on(t)), !t)) return new Y()
...
Tn.prototype = ms.prototype = {
	...
	on: function (t, n) {
		...
		if (arguments.length < 2) {
			for (; ++s < o; )
				if ((i = (t = r[s]).type) && (i = sl(e[i], t.name))) return i
			return
		}
		if (n != null && typeof n != 'function')
			throw new Error('invalid callback: ' + n)
		for (; ++s < o; )
			if ((i = (t = r[s]).type)) e[i] = ai(e[i], t.name, n)
			else if (n == null) for (i in e) e[i] = ai(e[i], t.name, null)
		return this
	},
	copy: function () {
		var t = {},
...
const ui = (function t(n) {
	var e = fl(n)
	function r(i, s) {
		var o = e((i = Ue(i)).r, (s = Ue(s)).r),
			a = e(i.g, s.g),
			u = e(i.b, s.b),
			f = $s(i.opacity, s.opacity)
		return function (l) {
			return (
				(i.r = o(l)), (i.g = a(l)), (i.b = u(l)), (i.opacity = f(l)), i + ''
			)
...
function hl(t, n) {
	var e = (Ye.lastIndex = Ce.lastIndex = 0),
		r,
		i,
		s,
		o = -1,
...
function dl(t) {
	return t === 'none'
		...
		: (Lt ||
				...
				(li = document.defaultView)),
		  (Lt.style.transform = t),
		  (t = li
				.getComputedStyle(Me.appendChild(Lt), null)
				.getPropertyValue('transform')),
		  Me.removeChild(Lt),
		  (t = t.slice(7, -1).split(',')),
		  bs(+t[0], +t[1], +t[2], +t[3], +t[4], +t[5]))
}
function pl(t) {
	return t == null ||
		...
		? Ge
		: ((t = t.matrix), bs(t.a, t.b, t.c, t.d, t.e, t.f))
}
function Ns(t, n, e, r) {
	function i(f) {
		return f.length ? f.pop() + ' ' : ''
	...
	function o(f, l, c, h) {
		f !== l
			? (f - l > 180 ? (l += 360) : l - f > 180 && (f += 360),
			  h.push({ i: c.push(i(c) + 'rotate(', null, r) - 2, x: ot(f, l) }))
			: l && c.push(i(c) + 'rotate(' + l + r)
	}
	function a(f, l, c, h) {
		f !== l
			? h.push({ i: c.push(i(c) + 'skewX(', null, r) - 2, x: ot(f, l) })
			: l && c.push(i(c) + 'skewX(' + l + r)
	}
	function u(f, l, c, h, d, g) {
		if (f !== c || l !== h) {
...
function ae(t) {
	...
	return (
		e >= 0 && (n = t.slice(0, e)) !== 'xmlns' && (t = t.slice(e + 1)),
		ci.hasOwnProperty(n) ? { space: ci[n], local: t } : t
	)
}
function vl(t) {
	return function () {
		var n = this.ownerDocument,
			e = this.namespaceURI
		return e === We && n.documentElement.namespaceURI === We
			? n.createElement(t)
			: n.createElementNS(e, t)
	}
}
...
function El(t, n, e, r, i, s, o) {
	...
	for (a = 0; a < l; ++a)
		(u = n[a]) &&
			((h[a] = d = hi + o.call(u, u.__data__, a, n)),
			d in f ? (i[a] = u) : (f[d] = u))
	for (a = 0; a < c; ++a)
		(d = hi + o.call(t, s[a], a, s)),
			(u = f[d])
				? ((r[a] = u), (u.__data__ = s[a]), (f[d] = null))
				: (e[a] = new Un(t, s[a]))
	for (a = 0; a < l; ++a) (u = n[a]) && f[h[a]] === u && (i[a] = u)
...
function jl(t, n, e) {
	return arguments.length > 1
		? this.each(
				(n == null ? Zl : typeof n == 'function' ? Ql : Jl)(t, n, e ?? '')
		  )
		: At(this.node(), t)
}
function At(t, n) {
...
function rc(t, n) {
	return arguments.length > 1
		? this.each((n == null ? tc : typeof n == 'function' ? ec : nc)(t, n))
		: this.node()[t]
}
function ks(t) {
	return t.trim().split(/^|\s+/)
...
function Ts(t, n) {
	for (var e = wr(t), r = -1, i = n.length; ++r < i; ) e.add(n[r])
}
function Is(t, n) {
	for (var e = wr(t), r = -1, i = n.length; ++r < i; ) e.remove(n[r])
}
function ic(t) {
	return function () {
		Ts(this, t)
...
function cc(t) {
	return arguments.length
		? this.each(t == null ? uc : (typeof t == 'function' ? lc : fc)(t))
		: this.node().textContent
}
function hc() {
	this.innerHTML = ''
...
function gc(t) {
	return arguments.length
		? this.each(t == null ? hc : (typeof t == 'function' ? pc : dc)(t))
		: this.node().innerHTML
}
function xc() {
	this.nextSibling && this.parentNode.appendChild(this)
...
function $c(t, n) {
	var e = typeof t == 'function' ? t : As(t),
		r = n == null ? wc : typeof n == 'function' ? n : mr(n)
	return this.select(function () {
		return this.insertBefore(
			e.apply(this, arguments),
			r.apply(this, arguments) || null
...
if (typeof document < 'u') {
	...
	'onmouseenter' in Ec ||
		(Ps = { mouseenter: 'mouseover', mouseleave: 'mouseout' })
}
function kc(t, n, e) {
	return (
		(t = Ls(t, n, e)),
...
function Ft(t) {
	return typeof t == 'string'
		? new O([[document.querySelector(t)]], [document.documentElement])
		: new O([[t]], Os)
}
var Ct = 0,
	Yt = 0,
	...
	lt = 0,
	ue = 0,
	an = typeof performance == 'object' && performance.now ? performance : Date,
	Ds =
		typeof window == 'object' && window.requestAnimationFrame
			? window.requestAnimationFrame.bind(window)
			: function (t) {
...
Wn.prototype = qs.prototype = {
	...
	restart: function (t, n, e) {
		if (typeof t != 'function')
			throw new TypeError('callback is not a function')
		;(e = (e == null ? fe() : +e) + (n == null ? 0 : +n)),
			!this._next &&
				Gt !== this &&
				(Gt ? (Gt._next = this) : (Yn = this), (Gt = this)),
			(this._call = t),
			(this._time = e),
			Ke()
	},
...
function Hc() {
	for (var t, n = Yn, e, r = 1 / 0; n; )
		n._call
			? (r > n._time && (r = n._time), (t = n), (n = n._next))
			: ((e = n._next), (n._next = null), (n = t ? (t._next = e) : (Yn = e)))
	;(Gt = t), Ke(r)
}
function Ke(t) {
	if (!Ct) {
		...
		var n = t - lt
		n > 24
			? (t < 1 / 0 && (Yt = setTimeout(di, t - an.now() - ue)),
			  Ot && (Ot = clearInterval(Ot)))
			: (Ot || ((Gn = an.now()), (Ot = setInterval(qc, zs))), (Ct = 1), Ds(di))
	}
}
function pi(t, n, e) {
	var r = new Wn()
...
var Xc = ms('start', 'end', 'cancel', 'interrupt'),
	Bc = [],
	Hs = 0,
	gi = 1,
	Ze = 2,
...
function rt(t, n) {
	var e = B(t, n)
	if (e.state > In) throw new Error('too late; already running')
	return e
}
function B(t, n) {
	var e = t.__transition
...
function Vc(t, n, e) {
	...
	function o(f) {
		var l, c, h, d
		if (e.state !== gi) return u()
		for (l in r)
			if (((d = r[l]), d.name === e.name)) {
				if (d.state === In) return pi(o)
				d.state === xi
					? ((d.state = Pn),
					  d.timer.stop(),
					  d.on.call('interrupt', t, t.__data__, d.index, d.group),
		...
		if (
			(pi(function () {
				e.state === In &&
					((e.state = xi), e.timer.restart(a, e.delay, e.time), a(f))
			}),
			(e.state = Ze),
			e.on.call('start', t, t.__data__, e.index, e.group),
			e.state === Ze)
			...
			for (
				e.state = In, i = new Array((h = e.tween.length)), l = 0, c = -1;
				l < h;
				++l
			)
				(d = e.tween[l].value.call(t, t.__data__, e.index, e.group)) &&
	...
	function a(f) {
		for (
			var l =
					f < e.duration
						? e.ease.call(null, f / e.duration)
						: (e.timer.restart(u), (e.state = Je), 1),
				c = -1,
				h = i.length;
			++c < h;
...
function eh(t, n) {
	...
	return this.attrTween(
		t,
		typeof n == 'function'
			? (e.local ? nh : th)(e, r, br(this, 'attr.' + t, n))
			: n == null
			? (e.local ? Jc : Zc)(e)
			: (e.local ? jc : Qc)(e, r, n)
	)
...
function lh(t) {
	var n = this._id
	return arguments.length
		? this.each((typeof t == 'function' ? uh : fh)(n, t))
		: B(this.node(), n).delay
}
function ch(t, n) {
	return function () {
...
function dh(t) {
	var n = this._id
	return arguments.length
		? this.each((typeof t == 'function' ? ch : hh)(n, t))
...
function Mh(t, n) {
	...
	return function () {
		var s = At(this, t),
			o = (this.style.removeProperty(t), At(this, t))
		return s === o ? null : s === e && o === r ? i : (i = n((e = s), (r = o)))
	}
}
function Bs(t) {
...
function Eh(t, n, e) {
	...
	return function () {
		var o = At(this, t),
			...
			u = a + ''
		return (
			a == null && (u = a = (this.style.removeProperty(t), At(this, t))),
			o === u ? null : o === r && u === i ? s : ((i = u), (s = n((r = o), a)))
		)
	}
}
function kh(t, n) {
	...
	return function () {
		var u = rt(this, t),
			f = u.on,
			l = u.value[s] == null ? a || (a = Bs(n)) : void 0
		;(f !== e || i !== l) && (r = (e = f).copy()).on(o, (i = l)), (u.on = r)
	}
}
function Sh(t, n, e) {
	...
	return n == null
		? this.styleTween(t, Mh(t, r)).on('end.style.' + t, Bs(t))
		: typeof n == 'function'
		? this.styleTween(t, Eh(t, r, br(this, 'style.' + t, n))).each(
				kh(this._id, t)
		  )
		: this.styleTween(t, Rh(t, r, n), e).on('end.style.' + t, null)
}
function Th(t, n, e) {
	return function (r) {
		this.style.setProperty(t, n.call(this, r), e)
...
function Vh(t, n) {
	for (var e; !(e = t.__transition) || !(e = e[n]); )
		if (!(t = t.parentNode)) return (Qe.time = fe()), Qe
	return e
}
function Uh(t) {
	var n, e
	t instanceof tt
		? ((n = t._id), (t = t._name))
		: ((n = Vs()), ((e = Qe).time = fe()), (t = t == null ? null : t + ''))
	for (var r = this._groups, i = r.length, s = 0; s < i; ++s)
		for (var o = r[s], a = o.length, u, f = 0; f < a; ++f)
...
Kn.prototype = {
	...
	insert: function (t, n) {
		...
		if (t) {
			...
			this._
				? ((t = yi(this._)), (n.P = null), (n.N = t), (t.P = t.L = n), (e = t))
		...
		if (
			...
			do {
				...
				if (t === n.L) {
					if (
						((e = n.R),
						e.C && ((e.C = !1), (n.C = !0), zt(this, n), (e = n.R)),
						(e.L && e.L.C) || (e.R && e.R.C))
					) {
						;(!e.R || !e.R.C) &&
							((e.L.C = !1), (e.C = !0), Dt(this, e), (e = n.R)),
							(e.C = n.C),
							(n.C = e.R.C = !1),
							zt(this, n),
							(t = this._)
					...
					((e = n.L),
					e.C && ((e.C = !1), (n.C = !0), Dt(this, n), (e = n.L)),
					(e.L && e.L.C) || (e.R && e.R.C))
				) {
					;(!e.L || !e.L.C) &&
						((e.R.C = !1), (e.C = !0), zt(this, e), (e = n.L)),
						(e.C = n.C),
						(n.C = e.L.C = !1),
						Dt(this, n),
						(t = this._)
...
function Wt(t, n, e, r) {
	...
	return (
		...
		e && Zn(i, t, n, e),
		r && Zn(i, n, t, r),
		I[t.index].halfedges.push(s),
		I[n.index].halfedges.push(s),
		i
	)
}
function qt(t, n, e) {
...
function Qh() {
	for (var t = 0, n = I.length, e, r, i, s; t < n; ++t)
		if ((e = I[t]) && (s = (r = e.halfedges).length)) {
			var o = new Array(s),
				a = new Array(s)
			for (i = 0; i < s; ++i) (o[i] = i), (a[i] = Zh(e, E[r[i]]))
			for (
				o.sort(function (u, f) {
					return a[f] - a[u]
				}),
...
function jh(t, n, e, r) {
	...
	for (s = 0; s < i; ++s) (o = I[s]) && (o.halfedges.length || delete I[s])
}
var Ys = [],
	Nr
function t0() {
...
function e0(t) {
	...
	;(u = a[0]),
		(f = a[l - 1]),
		(f.edge = Wt(u.site, f.site, null, i)),
		xt(u),
		xt(f)
}
function r0(t) {
	for (var n = t[0], e = t[1], r, i, s, o, a = mt._; a; )
		if (((s = Ws(a, e) - n), s > A)) a = a.L
	...
	if ((mt.insert(r, u), !(!r && !i))) {
		if (r === i) {
			vt(r),
				(i = _i(r.site)),
				mt.insert(u, i),
				(u.edge = i.edge = Wt(r.site, u.site)),
				xt(r),
				xt(i)
			return
		}
		...
		var f = r.site,
			...
			v = h * h + d * d,
			y = p * p + x * x,
			b = [(x * v - d * y) / $ + l, (h * y - p * v) / $ + c]
		Zn(i.edge, f, g, b),
			(u.edge = Wt(f, t, null, b)),
			(i.edge = Wt(t, g, null, b)),
			xt(r),
			xt(i)
	}
}
...
Ln.prototype = Ks.prototype = {
	...
	on: function (t, n) {
		...
		if (arguments.length < 2) {
			for (; ++s < o; )
				if ((i = (t = r[s]).type) && (i = l0(e[i], t.name))) return i
			return
		}
		if (n != null && typeof n != 'function')
			throw new Error('invalid callback: ' + n)
		for (; ++s < o; )
			if ((i = (t = r[s]).type)) e[i] = mi(e[i], t.name, n)
...
var fn = 0.7,
	...
	Z = '\\s*([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)%\\s*',
	c0 = /^#([0-9a-f]{3,8})$/,
	h0 = new RegExp('^rgb\\(' + [wt, wt, wt] + '\\)$'),
	d0 = new RegExp('^rgb\\(' + [Z, Z, Z] + '\\)$'),
	p0 = new RegExp('^rgba\\(' + [wt, wt, wt, ln] + '\\)$'),
	g0 = new RegExp('^rgba\\(' + [Z, Z, Z, ln] + '\\)$'),
	x0 = new RegExp('^hsl\\(' + [ln, Z, Z] + '\\)$'),
	y0 = new RegExp('^hsla\\(' + [ln, Z, Z, ln] + '\\)$'),
	wi = {
		aliceblue: 15792383,
		antiquewhite: 16444375,
		aqua: 65535,
...
function cn(t) {
	...
	return (
		...
		(n = c0.exec(t))
			...
			? Mn(n[1], n[2], n[3], n[4])
			: (n = g0.exec(t))
			? Mn((n[1] * 255) / 100, (n[2] * 255) / 100, (n[3] * 255) / 100, n[4])
			: (n = x0.exec(t))
			? Mi(n[1], n[2] / 100, n[3] / 100, 1)
			: (n = y0.exec(t))
			? Mi(n[1], n[2] / 100, n[3] / 100, n[4])
			: wi.hasOwnProperty(t)
			? Ni(wi[t])
			: t === 'transparent'
			? new F(NaN, NaN, NaN, 0)
...
function Js(t) {
	...
	if ((t instanceof _n || (t = cn(t)), !t)) return new G()
...
const Ri = (function t(n) {
	var e = b0(n)
	function r(i, s) {
		var o = e((i = je(i)).r, (s = je(s)).r),
			a = e(i.g, s.g),
			u = e(i.b, s.b),
			f = js(i.opacity, s.opacity)
		return function (l) {
			return (
				(i.r = o(l)), (i.g = a(l)), (i.b = u(l)), (i.opacity = f(l)), i + ''
			)
...
function C0(t, n) {
	var e = (tr.lastIndex = Se.lastIndex = 0),
		r,
		i,
		s,
		o = -1,
...
function M0(t) {
	return t === 'none'
		...
		: (Ht ||
				...
				(ki = document.defaultView)),
		  (Ht.style.transform = t),
		  (t = ki
				.getComputedStyle(Te.appendChild(Ht), null)
				.getPropertyValue('transform')),
		  Te.removeChild(Ht),
		  (t = t.slice(7, -1).split(',')),
		  to(+t[0], +t[1], +t[2], +t[3], +t[4], +t[5]))
}
function R0(t) {
	return t == null ||
		...
		? nr
		: ((t = t.matrix), to(t.a, t.b, t.c, t.d, t.e, t.f))
}
function no(t, n, e, r) {
	function i(f) {
		return f.length ? f.pop() + ' ' : ''
...
function he(t) {
	...
	return (
		e >= 0 && (n = t.slice(0, e)) !== 'xmlns' && (t = t.slice(e + 1)),
		Si.hasOwnProperty(n) ? { space: Si[n], local: t } : t
	)
}
function S0(t) {
	return function () {
		var n = this.ownerDocument,
			e = this.namespaceURI
		return e === er && n.documentElement.namespaceURI === er
			? n.createElement(t)
			: n.createElementNS(e, t)
	}
}
...
function H0(t, n, e, r, i, s, o) {
	...
	for (a = 0; a < l; ++a)
		(u = n[a]) &&
			((h[a] = d = Ti + o.call(u, u.__data__, a, n)),
			d in f ? (i[a] = u) : (f[d] = u))
	for (a = 0; a < c; ++a)
		(d = Ti + o.call(t, s[a], a, s)),
			(u = f[d])
				? ((r[a] = u), (u.__data__ = s[a]), (f[d] = null))
				: (e[a] = new Qn(t, s[a]))
	for (a = 0; a < l; ++a) (u = n[a]) && f[h[a]] === u && (i[a] = u)
...
function cd(t, n, e) {
	return arguments.length > 1
		? this.each(
				(n == null ? ud : typeof n == 'function' ? ld : fd)(t, n, e ?? '')
		  )
		: Mt(this.node(), t)
}
function Mt(t, n) {
	return (
		t.style.getPropertyValue(n) ||
		oo(t).getComputedStyle(t, null).getPropertyValue(n)
	)
}
function hd(t) {
	return function () {
...
function gd(t, n) {
	return arguments.length > 1
		? this.each((n == null ? hd : typeof n == 'function' ? pd : dd)(t, n))
		: this.node()[t]
}
function ao(t) {
	return t.trim().split(/^|\s+/)
...
function fo(t, n) {
	for (var e = Mr(t), r = -1, i = n.length; ++r < i; ) e.add(n[r])
}
function lo(t, n) {
	for (var e = Mr(t), r = -1, i = n.length; ++r < i; ) e.remove(n[r])
}
function xd(t) {
	return function () {
		fo(this, t)
...
function bd(t) {
	return arguments.length
		? this.each(t == null ? md : (typeof t == 'function' ? $d : wd)(t))
		: this.node().textContent
}
function Nd() {
	this.innerHTML = ''
...
function Md(t) {
	return arguments.length
		? this.each(t == null ? Nd : (typeof t == 'function' ? Cd : Ad)(t))
		: this.node().innerHTML
}
function Rd() {
	this.nextSibling && this.parentNode.appendChild(this)
...
function Pd(t, n) {
	var e = typeof t == 'function' ? t : eo(t),
		r = n == null ? Id : typeof n == 'function' ? n : Cr(n)
	return this.select(function () {
		return this.insertBefore(
			e.apply(this, arguments),
			r.apply(this, arguments) || null
...
if (typeof document < 'u') {
	...
	'onmouseenter' in Hd ||
		(co = { mouseenter: 'mouseover', mouseleave: 'mouseout' })
}
function Xd(t, n, e) {
	return (
		(t = ho(t, n, e)),
...
ne.prototype = yo.prototype = {
	...
	restart: function (t, n, e) {
		if (typeof t != 'function')
			throw new TypeError('callback is not a function')
		;(e = (e == null ? pe() : +e) + (n == null ? 0 : +n)),
			!this._next &&
				Zt !== this &&
				(Zt ? (Zt._next = this) : (jn = this), (Zt = this)),
			(this._call = t),
			(this._time = e),
			rr()
	},
...
function tp() {
	for (var t, n = jn, e, r = 1 / 0; n; )
		n._call
			? (r > n._time && (r = n._time), (t = n), (n = n._next))
			: ((e = n._next), (n._next = null), (n = t ? (t._next = e) : (jn = e)))
	;(Zt = t), rr(r)
}
function rr(t) {
	if (!Rt) {
		...
		var n = t - ct
		n > 24
			? (t < 1 / 0 && (Kt = setTimeout(Ii, t - hn.now() - de)),
			  Xt && (Xt = clearInterval(Xt)))
			: (Xt || ((te = hn.now()), (Xt = setInterval(jd, go))), (Rt = 1), xo(Ii))
	}
}
function Pi(t, n, e) {
	var r = new ne()
...
var np = Ks('start', 'end', 'cancel', 'interrupt'),
	ep = [],
	_o = 0,
	Li = 1,
	ir = 2,
...
function Rr(t, n) {
	var e = V(t, n)
	if (e.state > _o) throw new Error('too late; already scheduled')
	return e
}
function it(t, n) {
	var e = V(t, n)
...
function rp(t, n, e) {
	...
	function o(f) {
		var l, c, h, d
		if (e.state !== Li) return u()
		for (l in r)
			if (((d = r[l]), d.name === e.name)) {
				if (d.state === Fn) return Pi(o)
				d.state === Fi
					? ((d.state = On),
					  d.timer.stop(),
					  d.on.call('interrupt', t, t.__data__, d.index, d.group),
		...
		if (
			(Pi(function () {
				e.state === Fn &&
					((e.state = Fi), e.timer.restart(a, e.delay, e.time), a(f))
			}),
			(e.state = ir),
			e.on.call('start', t, t.__data__, e.index, e.group),
			e.state === ir)
			...
			for (
				e.state = Fn, i = new Array((h = e.tween.length)), l = 0, c = -1;
				l < h;
				++l
			)
				(d = e.tween[l].value.call(t, t.__data__, e.index, e.group)) &&
	...
	function a(f) {
		for (
			var l =
					f < e.duration
						? e.ease.call(null, f / e.duration)
						: (e.timer.restart(u), (e.state = sr), 1),
				c = -1,
				h = i.length;
			++c < h;
...
function gp(t, n) {
	...
	return this.attrTween(
		t,
		typeof n == 'function'
			? (e.local ? pp : dp)(e, r, Er(this, 'attr.' + t, n))
			: n == null
			? (e.local ? lp : fp)(e)
			: (e.local ? hp : cp)(e, r, n)
	)
...
function bp(t) {
	var n = this._id
	return arguments.length
		? this.each((typeof t == 'function' ? wp : $p)(n, t))
		: V(this.node(), n).delay
}
function Np(t, n) {
	return function () {
...
function Cp(t) {
	var n = this._id
	return arguments.length
		? this.each((typeof t == 'function' ? Np : Ap)(n, t))
...
function Bp(t, n) {
	...
	return function () {
		var u = it(this, t),
			f = u.on,
			l = u.value[s] == null ? a || (a = mo(n)) : void 0
		;(f !== e || i !== l) && (r = (e = f).copy()).on(o, (i = l)), (u.on = r)
	}
}
function Vp(t, n, e) {
	...
	return n == null
		? this.styleTween(t, qp(t, r)).on('end.style.' + t, mo(t))
		: typeof n == 'function'
		? this.styleTween(t, Xp(t, r, Er(this, 'style.' + t, n))).each(
				Bp(this._id, t)
		  )
		: this.styleTween(t, Hp(t, r, n), e).on('end.style.' + t, null)
}
function Up(t, n, e) {
	return function (r) {
		this.style.setProperty(t, n.call(this, r), e)
...
function ig(t, n) {
	for (var e; !(e = t.__transition) || !(e = e[n]); )
		if (!(t = t.parentNode)) return (or.time = pe()), or
	return e
}
function sg(t) {
	var n, e
	t instanceof nt
		? ((n = t._id), (t = t._name))
		: ((n = wo()), ((e = or).time = pe()), (t = t == null ? null : t + ''))
	for (var r = this._groups, i = r.length, s = 0; s < i; ++s)
		for (var o = r[s], a = o.length, u, f = 0; f < a; ++f)
...
Jt.prototype = {
	...
	translate: function (t, n) {
		return (t === 0) & (n === 0)
			? this
			: new Jt(this.k, this.x + this.k * t, this.y + this.k * n)
	},
	apply: function (t) {
...
function $o(t, n, e) {
	...
	function $(k) {
		for (var M = 0; M < k.length; M++) g[d][M] = k[M]
		g[d].fx = k.fx
	}
	for (
		var v = function (k, M) {
		...
		for (h = 0, p = 0; p < d; ++p) h = Math.max(h, Math.abs(g[0][p] - g[1][p]))
		if (Math.abs(g[0].fx - g[d].fx) < o && h < a) break
		for (p = 0; p < d; ++p) {
			y[p] = 0
			for (var z = 0; z < d; ++z) y[p] += g[z][p]
			y[p] /= d
		}
		var R = g[d]
...
function ug(t, n, e) {
	...
	for (var l = 0; l < f; ++l) {
		if (
			...
			var c = $t(r.fxprime, r.fxprime),
				h = Math.max(0, $t(s, i.fxprime) / c)
			Q(o, h, o, -1, i.fxprime), (a = r), (r = i), (i = a)
		}
		if (ur(r.fxprime) <= 1e-5) break
	}
	return (
		e.history &&
			e.history.push({
...
const Co = 1e-10
function cr(t, n, e) {
	return Math.min(t, n) * Math.min(t, n) * Math.PI <= e + Co
		? Math.abs(t - n)
		: og((r) => kr(t, n, r) - e, 0, t + n)
}
function hg(t, n = {}) {
	const e = n.distinct,
...
function dg(t, n, e) {
	const r = Oi(n.length, n.length),
		i = Oi(n.length, n.length)
	return (
		t
...
function xg(t, n = {}) {
	...
	let f = null
	for (let h = 0; h < e; ++h) {
		const d = ar(s.length * 2).map(Math.random),
			g = ug(u, d, n)
		;(!f || g.fx < f.fx) && (f = g)
	}
	const l = f.x,
	...
	if (n.history) for (const h of n.history) fr(h.x, a)
	return c
}
function yg(t, n) {
	const e = n && n.lossFunction ? n.lossFunction : dn,
		r = {},
		i = {}
	for (const c of t)
		if (c.sets.length === 1) {
	...
	for (const c of t) {
		...
		const d = c.sets[0],
			g = c.sets[1]
		c.size + Co >= Math.min(r[d].size, r[g].size) && (h = 0),
	...
	for (let c = 1; c < s.length; ++c) {
		...
		for (var l = 0; l < d.length; ++l) {
			const v = r[d[l].set],
				y = cr(g.radius, v.radius, d[l].size)
			p.push({ x: v.x + y, y: v.y }),
				p.push({ x: v.x - y, y: v.y }),
				p.push({ y: v.y + y, x: v.x }),
				p.push({ y: v.y - y, x: v.x })
			for (let b = l + 1; b < d.length; ++b) {
				const N = r[d[b].set],
					_ = cr(g.radius, N.radius, d[b].size),
					m = No({ x: v.x, y: v.y, radius: y }, { x: N.x, y: N.y, radius: _ })
				p.push(...m)
			}
		}
		let x = 1e50,
...
function bg(t = {}) {
	...
	function _(m) {
			...
			return (T) => {
				const Po = w.sets.map((Lr) => {
					let St = Sr[Lr],
						Tt = R[Lr]
					return (
						St || (St = { x: e / 2, y: r / 2, radius: 1 }),
						Tt || (Tt = { x: e / 2, y: r / 2, radius: 1 }),
						{
							x: St.x * (1 - T) + Tt.x * T,
							y: St.y * (1 - T) + Tt.y * T,
		...
		const wn = mn.selectAll('.venn-area').data(C, (w) => w.sets),
			_e = wn
				.enter()
				.append('g')
				.attr(
					'class',
					(w) =>
						`venn-area venn-${w.sets.length == 1 ? 'circle' : 'intersection'}${
			...
			Ir = _e
				...
				.attr('y', r / 2)
		l &&
			(To.style('fill-opacity', '0')
				.filter((w) => w.sets.length == 1)
				.style('fill', (w) =>
					w.colour ? w.colour : w.color ? w.color : y(w.sets)
				)
		...
		let ht = m
		ye && typeof ht.transition == 'function'
			? ((ht = Pr(m)), ht.selectAll('path').attrTween('d', Tr))
			: ht.selectAll('path').attr('d', (w) => zi(w.sets.map((T) => R[T])), g)
		const kt = ht
			.selectAll('text')
			.filter((w) => w.sets in J)
			.text((w) => M(w))
			.attr('x', (w) => Math.floor(J[w.sets].x))
			.attr('y', (w) => Math.floor(J[w.sets].y))
		f &&
			(ye
				? 'on' in kt
					? kt.on('end', Ie(R, M))
		...
		typeof wn.transition == 'function' &&
			ve.selectAll('path').attrTween('d', Tr)
		const Io = ve
			.selectAll('text')
			.attr('x', e / 2)
			.attr('y', r / 2)
		return (
			c !== null &&
				(Ir.style('font-size', '0px'),
				kt.style('font-size', c),
				Io.style('font-size', '0px')),
			{ circles: R, textCentres: J, nodes: wn, enter: _e, update: ht, exit: ve }
		)
	}
	return (
		(_.wrap = function (m) {
		...
		(_.lossFunction = function (m) {
			return arguments.length
				? ((N = m === 'default' ? dn : m === 'logRatio' ? _g : m), _)
				: N
		}),
		_
	)
...
function Eo(t, n, e) {
	...
	const o = $o((l) => -1 * Pe({ x: l[0], y: l[1] }, t, n), [i.x, i.y], {
			maxIterations: 500,
			minErrorDelta: 1e-10
		}).x,
		a = { x: e ? 0 : o[0], y: o[1] }
...
const Sg = kg
var Tg = typeof self == 'object' && self && self.Object === Object && self,
	Ig = Sg || Tg || Function('return this')()
const ko = Ig
var Pg = ko.Symbol
const ee = Pg
var So = Object.prototype,
	Lg = So.hasOwnProperty,
	Fg = So.toString,
	Bt = ee ? ee.toStringTag : void 0
function Og(t) {
	var n = Lg.call(t, Bt),
		e = t[Bt]
	try {
...
function Xi(t, n, e) {
	var r,
		...
		c = !1,
		h = !0
	if (typeof t != 'function') throw new TypeError(ex)
	;(n = Hi(n) || 0),
		dr(e) &&
			((l = !!e.leading),
			(c = 'maxWait' in e),
			(s = c ? rx(Hi(e.maxWait) || 0, n) : s),
...
const sx = (t) => (Bo('data-v-95993e2b'), (t = t()), Vo(), t),
	ox = { class: 'wrapper-venn' },
	ax = /* @__PURE__ */ sx(() =>
		/* @__PURE__ */ Uo('div', { id: 'venn' }, null, -1)
	),
	ux = [ax],
	fx = Bi({
		name: 'VennChart'
			...
			function f() {
				...
				c.selectAll('g')
					...
					.on('mousemove', function (g, p) {
						d.style('left', Qt.pageX + e.tooltipOffsetX + 'px').style(
							'top',
							Qt.pageY + e.tooltipOffsetY + 'px'
						)
					})
...
const cx = (t, n) => {
	...
	Fe = /* @__PURE__ */ cx(lx, [['__scopeId', 'data-v-974e8b18']])
Fe.install = (t) => {
	t.component(Fe.name, Fe)
}
export { Fe as VennChart, Fe as default }
