import { defineComponent as Bi, useCssVars as Fo, ref as $n, watch as Oo, onMounted as zo, getCurrentInstance as Do, onUnmounted as qo, openBlock as Ho, createElementBlock as Xo, pushScopeId as Bo, popScopeId as Vo, createElementVNode as Uo } from "vue";
function Vi(t, n) {
...
const Vr = function t(n) {
  var e = fa(n);
  function r(i, s) {
    var o = e((i = Fe(i)).r, (s = Fe(s)).r), a = e(i.g, s.g), u = e(i.b, s.b), f = Ki(i.opacity, s.opacity);
    return function(l) {
...
var Oe = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, $e = new RegExp(Oe.source, "g");
function la(t) {
  return function() {
    return t;
  };
...
function ha(t, n) {
  var e = Oe.lastIndex = $e.lastIndex = 0, r, i, s, o = -1, a = [], u = [];
  for (t = t + "", n = n + ""; (r = Oe.exec(t)) && (i = $e.exec(n)); )
...
var It, be, Yr, Nn;
function da(t) {
  return t === "none" ? ze : (It || (It = document.createElement("DIV"), be = document.documentElement, Yr = document.defaultView), It.style.transform = t, t = Yr.getComputedStyle(be.appendChild(It), null).getPropertyValue("transform"), be.removeChild(It), t = t.slice(7, -1).split(","), Zi(+t[0], +t[1], +t[2], +t[3], +t[4], +t[5]));
}
function pa(t) {
  return t == null || (Nn || (Nn = document.createElementNS("http://www.w3.org/2000/svg", "g")), Nn.setAttribute("transform", t), !(t = Nn.transform.baseVal.consolidate())) ? ze : (t = t.matrix, Zi(t.a, t.b, t.c, t.d, t.e, t.f));
}
function Ji(t, n, e, r) {
  function i(f) {
...
var ga = Ji(da, "px, ", "px)", "deg)"), xa = Ji(pa, ", ", ")", ")"), De = "http://www.w3.org/1999/xhtml";
const Gr = {
...
function Ra(t, n) {
  ...
  var e = n ? Ca : Ma, r = this._parents, i = this._groups;
...
Xn.prototype = hs.prototype = {
  ...
  restart: function(t, n, e) {
    ...
    e = (e == null ? se() : +e) + (n == null ? 0 : +n), !this._next && Ut !== this && (Ut ? Ut._next = this : qn = this, Ut = this), this._call = t, this._time = e, qe();
  },
  stop: function() {
...
var Hu = Ui("start", "end", "cancel", "interrupt"), Xu = [], ds = 0, Jr = 1, He = 2, kn = 3, Qr = 4, Xe = 5, Sn = 6;
...
function Bu(t, n, e) {
  ...
  function a(f) {
    for (var l = f < e.duration ? e.ease.call(null, f / e.duration) : (e.timer.restart(u), e.state = Xe, 1), c = -1, h = i.length; ++c < h; )
      i[c].call(t, l);
    e.state === Xe && (e.on.call("end", t, t.__data__, e.index, e.group), u());
  }
  function u() {
...
function Vu(t, n) {
  ...
  if (e) {
    ...
    for (o in e) {
      ...
      i = r.state > He && r.state < Xe, r.state = Sn, r.timer.stop(), r.on.call(i ? "interrupt" : "cancel", t, t.__data__, r.index, r.group), delete e[o];
    }
...
function Sf(t, n, e) {
  ...
  return n == null ? this.styleTween(t, Cf(t, r)).on("end.style." + t, gs(t)) : typeof n == "function" ? this.styleTween(t, Ef(t, r, _r(this, "style." + t, n))).each(kf(this._id, t)) : this.styleTween(t, Rf(t, r, n), e).on("end.style." + t, null);
}
function Tf(t, n, e) {
  return function(r) {
...
function Uf(t, n) {
  for (var e; !(e = t.__transition) || !(e = e[n]); )
    if (!(t = t.parentNode))
      return Be.time = se(), Be;
  return e;
}
function Yf(t) {
  var n, e;
  t instanceof j ? (n = t._id, t = t._name) : (n = xs(), (e = Be).time = se(), t = t == null ? null : t + "");
...
const ui = function t(n) {
  var e = fl(n);
  function r(i, s) {
    var o = e((i = Ve(i)).r, (s = Ve(s)).r), a = e(i.g, s.g), u = e(i.b, s.b), f = $s(i.opacity, s.opacity);
    return function(l) {
      return i.r = o(l), i.g = a(l), i.b = u(l), i.opacity = f(l), i + "";
    };
  }
...
var Ue = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, Me = new RegExp(Ue.source, "g");
function ll(t) {
  return function() {
    return t;
  };
...
function hl(t, n) {
  var e = Ue.lastIndex = Me.lastIndex = 0, r, i, s, o = -1, a = [], u = [];
  for (t = t + "", n = n + ""; (r = Ue.exec(t)) && (i = Me.exec(n)); )
    (s = i.index) > e && (s = n.slice(e, s), a[o] ? a[o] += s : a[++o] = s), (r = r[0]) === (i = i[0]) ? a[o] ? a[o] += i : a[++o] = i : (a[++o] = null, u.push({ i: o, x: ot(r, i) })), e = Me.lastIndex;
...
var Lt, Ce, li, Mn;
function dl(t) {
  return t === "none" ? Ye : (Lt || (Lt = document.createElement("DIV"), Ce = document.documentElement, li = document.defaultView), Lt.style.transform = t, t = li.getComputedStyle(Ce.appendChild(Lt), null).getPropertyValue("transform"), Ce.removeChild(Lt), t = t.slice(7, -1).split(","), bs(+t[0], +t[1], +t[2], +t[3], +t[4], +t[5]));
}
function pl(t) {
  return t == null || (Mn || (Mn = document.createElementNS("http://www.w3.org/2000/svg", "g")), Mn.setAttribute("transform", t), !(t = Mn.transform.baseVal.consolidate())) ? Ye : (t = t.matrix, bs(t.a, t.b, t.c, t.d, t.e, t.f));
}
function Ns(t, n, e, r) {
  function i(f) {
    return f.length ? f.pop() + " " : "";
...
function vl(t) {
  return function() {
    var n = this.ownerDocument, e = this.namespaceURI;
    return e === Ge && n.documentElement.namespaceURI === Ge ? n.createElement(t) : n.createElementNS(e, t);
  };
}
function ml(t) {
  return function() {
...
var Mt = 0, Yt = 0, Ot = 0, zs = 1e3, Yn, Gt, Gn = 0, lt = 0, ue = 0, an = typeof performance == "object" && performance.now ? performance : Date, Ds = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t) {
  setTimeout(t, 17);
};
function fe() {
...
Wn.prototype = qs.prototype = {
  ...
  restart: function(t, n, e) {
    if (typeof t != "function")
      throw new TypeError("callback is not a function");
    e = (e == null ? fe() : +e) + (n == null ? 0 : +n), !this._next && Gt !== this && (Gt ? Gt._next = this : Yn = this, Gt = this), this._call = t, this._time = e, We();
  },
  stop: function() {
...
function We(t) {
  if (!Mt) {
    ...
    var n = t - lt;
    n > 24 ? (t < 1 / 0 && (Yt = setTimeout(di, t - an.now() - ue)), Ot && (Ot = clearInterval(Ot))) : (Ot || (Gn = an.now(), Ot = setInterval(qc, zs)), Mt = 1, Ds(di));
  }
}
function pi(t, n, e) {
  var r = new Wn();
...
var Xc = ms("start", "end", "cancel", "interrupt"), Bc = [], Hs = 0, gi = 1, Ke = 2, In = 3, xi = 4, Ze = 5, Pn = 6;
...
function Vc(t, n, e) {
  ...
  function o(f) {
    ...
    }), e.state = Ke, e.on.call("start", t, t.__data__, e.index, e.group), e.state === Ke) {
  ...
  function a(f) {
    for (var l = f < e.duration ? e.ease.call(null, f / e.duration) : (e.timer.restart(u), e.state = Ze, 1), c = -1, h = i.length; ++c < h; )
      i[c].call(t, l);
    e.state === Ze && (e.on.call("end", t, t.__data__, e.index, e.group), u());
  }
  function u() {
...
function Uc(t, n) {
  ...
  if (e) {
    ...
    for (o in e) {
      ...
      i = r.state > Ke && r.state < Ze, r.state = Pn, r.timer.stop(), r.on.call(i ? "interrupt" : "cancel", t, t.__data__, r.index, r.group), delete e[o];
    }
    s && delete t.__transition;
  }
}
...
function Sh(t, n, e) {
  ...
  return n == null ? this.styleTween(t, Ch(t, r)).on("end.style." + t, Bs(t)) : typeof n == "function" ? this.styleTween(t, Eh(t, r, br(this, "style." + t, n))).each(kh(this._id, t)) : this.styleTween(t, Rh(t, r, n), e).on("end.style." + t, null);
}
function Th(t, n, e) {
  return function(r) {
    this.style.setProperty(t, n.call(this, r), e);
...
function Vh(t, n) {
  for (var e; !(e = t.__transition) || !(e = e[n]); )
    if (!(t = t.parentNode))
      return Je.time = fe(), Je;
  return e;
}
function Uh(t) {
  var n, e;
  t instanceof tt ? (n = t._id, t = t._name) : (n = Vs(), (e = Je).time = fe(), t = t == null ? null : t + "");
  for (var r = this._groups, i = r.length, s = 0; s < i; ++s)
    for (var o = r[s], a = o.length, u, f = 0; f < a; ++f)
...
function cn(t) {
  var n, e;
  return t = (t + "").trim().toLowerCase(), (n = c0.exec(t)) ? (e = n[1].length, n = parseInt(n[1], 16), e === 6 ? Ni(n) : e === 3 ? new F(n >> 8 & 15 | n >> 4 & 240, n >> 4 & 15 | n & 240, (n & 15) << 4 | n & 15, 1) : e === 8 ? Cn(n >> 24 & 255, n >> 16 & 255, n >> 8 & 255, (n & 255) / 255) : e === 4 ? Cn(n >> 12 & 15 | n >> 8 & 240, n >> 8 & 15 | n >> 4 & 240, n >> 4 & 15 | n & 240, ((n & 15) << 4 | n & 15) / 255) : null) : (n = h0.exec(t)) ? new F(n[1], n[2], n[3], 1) : (n = d0.exec(t)) ? new F(n[1] * 255 / 100, n[2] * 255 / 100, n[3] * 255 / 100, 1) : (n = p0.exec(t)) ? Cn(n[1], n[2], n[3], n[4]) : (n = g0.exec(t)) ? Cn(n[1] * 255 / 100, n[2] * 255 / 100, n[3] * 255 / 100, n[4]) : (n = x0.exec(t)) ? Ci(n[1], n[2] / 100, n[3] / 100, 1) : (n = y0.exec(t)) ? Ci(n[1], n[2] / 100, n[3] / 100, n[4]) : wi.hasOwnProperty(t) ? Ni(wi[t]) : t === "transparent" ? new F(NaN, NaN, NaN, 0) : null;
}
function Ni(t) {
...
const Ri = function t(n) {
  var e = b0(n);
  function r(i, s) {
    var o = e((i = Qe(i)).r, (s = Qe(s)).r), a = e(i.g, s.g), u = e(i.b, s.b), f = js(i.opacity, s.opacity);
    return function(l) {
      return i.r = o(l), i.g = a(l), i.b = u(l), i.opacity = f(l), i + "";
    };
  }
...
var je = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, Se = new RegExp(je.source, "g");
function N0(t) {
  return function() {
    return t;
  };
...
function M0(t, n) {
  var e = je.lastIndex = Se.lastIndex = 0, r, i, s, o = -1, a = [], u = [];
  for (t = t + "", n = n + ""; (r = je.exec(t)) && (i = Se.exec(n)); )
...
var Ht, Te, ki, Rn;
function C0(t) {
  return t === "none" ? tr : (Ht || (Ht = document.createElement("DIV"), Te = document.documentElement, ki = document.defaultView), Ht.style.transform = t, t = ki.getComputedStyle(Te.appendChild(Ht), null).getPropertyValue("transform"), Te.removeChild(Ht), t = t.slice(7, -1).split(","), to(+t[0], +t[1], +t[2], +t[3], +t[4], +t[5]));
}
function R0(t) {
  return t == null || (Rn || (Rn = document.createElementNS("http://www.w3.org/2000/svg", "g")), Rn.setAttribute("transform", t), !(t = Rn.transform.baseVal.consolidate())) ? tr : (t = t.matrix, to(t.a, t.b, t.c, t.d, t.e, t.f));
}
function no(t, n, e, r) {
  function i(f) {
    return f.length ? f.pop() + " " : "";
...
var E0 = no(C0, "px, ", "px)", "deg)"), k0 = no(R0, ", ", ")", ")"), nr = "http://www.w3.org/1999/xhtml";
const Si = {
  svg: "http://www.w3.org/2000/svg",
  xhtml: nr,
  xlink: "http://www.w3.org/1999/xlink",
...
function S0(t) {
  return function() {
    var n = this.ownerDocument, e = this.namespaceURI;
    return e === nr && n.documentElement.namespaceURI === nr ? n.createElement(t) : n.createElementNS(e, t);
  };
}
function T0(t) {
  return function() {
...
function cd(t, n, e) {
  return arguments.length > 1 ? this.each((n == null ? ud : typeof n == "function" ? ld : fd)(t, n, e ?? "")) : Ct(this.node(), t);
}
function Ct(t, n) {
...
function fo(t, n) {
  for (var e = Cr(t), r = -1, i = n.length; ++r < i; )
    e.add(n[r]);
}
function lo(t, n) {
  for (var e = Cr(t), r = -1, i = n.length; ++r < i; )
...
function Cd(t) {
  return arguments.length ? this.each(t == null ? Nd : (typeof t == "function" ? Md : Ad)(t)) : this.node().innerHTML;
}
function Rd() {
  this.nextSibling && this.parentNode.appendChild(this);
}
...
function Pd(t, n) {
  var e = typeof t == "function" ? t : eo(t), r = n == null ? Id : typeof n == "function" ? n : Mr(n);
  return this.select(function() {
    return this.insertBefore(e.apply(this, arguments), r.apply(this, arguments) || null);
  });
}
...
ne.prototype = yo.prototype = {
  ...
  restart: function(t, n, e) {
    if (typeof t != "function")
      throw new TypeError("callback is not a function");
    e = (e == null ? pe() : +e) + (n == null ? 0 : +n), !this._next && Zt !== this && (Zt ? Zt._next = this : jn = this, Zt = this), this._call = t, this._time = e, er();
  },
  stop: function() {
...
var np = Ks("start", "end", "cancel", "interrupt"), ep = [], _o = 0, Li = 1, rr = 2, Fn = 3, Fi = 4, ir = 5, On = 6;
...
function rp(t, n, e) {
  ...
  function a(f) {
    for (var l = f < e.duration ? e.ease.call(null, f / e.duration) : (e.timer.restart(u), e.state = ir, 1), c = -1, h = i.length; ++c < h; )
      i[c].call(t, l);
    e.state === ir && (e.on.call("end", t, t.__data__, e.index, e.group), u());
  }
  function u() {
...
function ip(t, n) {
  ...
  if (e) {
    ...
    for (o in e) {
      ...
      i = r.state > rr && r.state < ir, r.state = On, r.timer.stop(), r.on.call(i ? "interrupt" : "cancel", t, t.__data__, r.index, r.group), delete e[o];
    }
    s && delete t.__transition;
  }
}
...
function vo(t, n) {
  var e;
  return (typeof n == "number" ? at : n instanceof cn ? Ri : (e = cn(n)) ? (n = e, Ri) : M0)(t, n);
}
function fp(t) {
  return function() {
    this.removeAttribute(t);
...
function qp(t, n) {
  var e, r, i;
  return function() {
    var s = Ct(this, t), o = (this.style.removeProperty(t), Ct(this, t));
    return s === o ? null : s === e && o === r ? i : i = n(e = s, r = o);
  };
}
function mo(t) {
...
function Xp(t, n, e) {
  var r, i, s;
  return function() {
    var o = Ct(this, t), a = e(this), u = a + "";
    return a == null && (u = a = (this.style.removeProperty(t), Ct(this, t))), o === u ? null : o === r && u === i ? s : (i = u, s = n(r = o, a));
  };
}
function Bp(t, n) {
  var e, r, i, s = "style." + n, o = "end." + s, a;
...
function ig(t, n) {
  for (var e; !(e = t.__transition) || !(e = e[n]); )
    if (!(t = t.parentNode))
      return sr.time = pe(), sr;
  return e;
}
function sg(t) {
  var n, e;
  t instanceof nt ? (n = t._id, t = t._name) : (n = wo(), (e = sr).time = pe(), t = t == null ? null : t + "");
  for (var r = this._groups, i = r.length, s = 0; s < i; ++s)
    for (var o = r[s], a = o.length, u, f = 0; f < a; ++f)
...
function ug(t, n, e) {
  ...
  e = e || {}, f = e.maxIterations || n.length * 20, r.fx = t(r.x, r.fxprime), o = r.fxprime.slice(), ur(o, r.fxprime, -1);
  for (var l = 0; l < f; ++l) {
...
function xe(t, n) {
  ...
  if (r.length > 1) {
    ...
    for (let f = 0; f < r.length; ++f) {
      ...
      h != null && (o.push(h), i += fr(h.circle.radius, h.width), u = l);
    }
  } else {
    let a = t[0];
...
const Mo = 1e-10;
function lr(t, n, e) {
  return Math.min(t, n) * Math.min(t, n) * Math.PI <= e + Mo ? Math.abs(t - n) : og((r) => kr(t, n, r) - e, 0, t + n);
}
function hg(t, n = {}) {
...
function dg(t, n, e) {
  ...
  return t.filter((s) => s.sets.length === 2).forEach((s) => {
    const o = e[s.sets[0]], a = e[s.sets[1]], u = Math.sqrt(n[o].size / Math.PI), f = Math.sqrt(n[a].size / Math.PI), l = lr(u, f, s.size);
    r[o][a] = r[a][o] = l;
    let c = 0;
...
function xg(t, n = {}) {
  ...
  const a = ar(s.map(ar)) / s.length;
  s = s.map((h) => h.map((d) => d / a));
  const u = (h, d) => pg(h, d, s, o);
  let f = null;
  for (let h = 0; h < e; ++h) {
    const d = or(s.length * 2).map(Math.random), g = ug(u, d, n);
    (!f || g.fx < f.fx) && (f = g);
  }
  const l = f.x, c = {};
...
function yg(t, n) {
  ...
  for (const c of t) {
    ...
    c.size + Mo >= Math.min(r[d].size, r[g].size) && (h = 0), i[d].push({ set: g, size: c.size, weight: h }), i[g].push({ set: d, size: c.size, weight: h });
  }
  const s = [];
...
function wg(t, n, e) {
  ...
  let u = 1;
  for (; u < i.length; )
    a(i[u], !0, !1), a(i[u + 1], !1, !0), a(i[u + 2], !0, !0), u += 3, s = cr(r);
  return Co(r);
}
function $g(t, n, e, r, i) {
  const s = Ro(t);
  n -= 2 * r, e -= 2 * r;
  const { xRange: o, yRange: a } = cr(s);
...
function bg(t = {}) {
  ...
  function _(m) {
    ...
    }), M = M.filter((w) => !w.sets.some((T) => z.has(T)));
    let R = {}, J = {};
    if (M.length > 0) {
      let w = b(M, { lossFunction: N, distinct: d });
      a && (w = wg(w, o, h)), R = $g(w, e, r, i, u), J = Ng(R, M, p);
    }
    const k = {};
    M.forEach((w) => {
    ...
    const wn = mn.selectAll(".venn-area").data(M, (w) => w.sets), _e = wn.enter().append("g").attr(
      "class",
      (w) => `venn-area venn-${w.sets.length == 1 ? "circle" : "intersection"}${w.colour || w.color ? " venn-coloured" : ""}`
    ).attr("data-venn-sets", (w) => w.sets.join("_")), Io = _e.append("path"), Ir = _e.append("text").attr("class", "label").text((w) => C(w)).attr("text-anchor", "middle").attr("dy", ".35em").attr("x", e / 2).attr("y", r / 2);
    l && (Io.style("fill-opacity", "0").filter((w) => w.sets.length == 1).style("fill", (w) => w.colour ? w.colour : w.color ? w.color : y(w.sets)).style("fill-opacity", ".25"), Ir.style("fill", (w) => w.colour || w.color ? "#FFF" : t.textFill ? t.textFill : w.sets.length == 1 ? y(w.sets) : "#444"));
    function Pr(w) {
    ...
    const kt = ht.selectAll("text").filter((w) => w.sets in J).text((w) => C(w)).attr("x", (w) => Math.floor(J[w.sets].x)).attr("y", (w) => Math.floor(J[w.sets].y));
    f && (ye ? "on" in kt ? kt.on("end", Ie(R, C)) : kt.each("end", Ie(R, C)) : kt.each(Ie(R, C)));
    const ve = Pr(wn.exit()).remove();
    typeof wn.transition == "function" && ve.selectAll("path").attrTween("d", Tr);
    const Po = ve.selectAll("text").attr("x", e / 2).attr("y", r / 2);
    return c !== null && (Ir.style("font-size", "0px"), kt.style("font-size", c), Po.style("font-size", "0px")), { circles: R, textCentres: J, nodes: wn, enter: _e, update: ht, exit: ve };
  }
...
function Ag(t, n) {
  const e = ko(t.selectAll("svg").datum()), r = /* @__PURE__ */ new Set();
  ...
  function i(s) {
    return s.every((o) => !r.has(o));
  }
  t.selectAll("g").sort((s, o) => s.sets.length != o.sets.length ? s.sets.length - o.sets.length : s == n ? i(o.sets) ? -1 : 1 : o == n ? i(s.sets) ? 1 : -1 : o.size - s.size);
}
function Mg(t, n, e) {
  const r = [];
  return r.push(`
...
function Eg(t, n) {
  ...
  if (t.length == 1) {
    const s = t[0].circle;
    return Mg(r(s.x), r(s.y), r(s.radius));
  }
  const i = [`
...
var Pg = So.Symbol;
const ee = Pg;
var To = Object.prototype, Lg = To.hasOwnProperty, Fg = To.toString, Bt = ee ? ee.toStringTag : void 0;
function Og(t) {
...
function Xi(t, n, e) {
  ...
  n = Hi(n) || 0, hr(e) && (l = !!e.leading, c = "maxWait" in e, s = c ? rx(Hi(e.maxWait) || 0, n) : s, h = "trailing" in e ? !!e.trailing : h);
  function d(_) {
    var m = r, M = i;
    return r = i = void 0, f = _, o = t.apply(M, m), o;
  }
  function g(_) {
    return f = _, a = setTimeout($, n), l ? d(_) : o;
  }
  function p(_) {
    var m = _ - u, M = _ - f, z = n - m;
    return c ? ix(z, s - M) : z;
  }
  function x(_) {
    var m = _ - u, M = _ - f;
    return u === void 0 || m >= n || m < 0 || c && M >= s;
  }
  function $() {
    var _ = Le();
    if (x(_))
...
const sx = (t) => (Bo("data-v-b9bc31d0"), t = t(), Vo(), t), ox = { class: "wrapper-venn" }, ax = /* @__PURE__ */ sx(() => /* @__PURE__ */ Uo("div", { id: "venn" }, null, -1)), ux = [
  ax
], fx = Bi({
  name: "VennChart"
}), lx = /* @__PURE__ */ Bi({
  ...
  props: {
    ...
    colors: { default: () => ["#ee4035", "#0392cf", "#7bc043"] },
    legend: { default: () => ["左边", "右边", "同时存在"] },
  ...
  setup(t, { emit: n }) {
    ...
    function a() {
      ...
      r.value = o.value.getBoundingClientRect().width, i.value = o.value.getBoundingClientRect().height;
      const u = Ft("#venn"), f = bg({
        symmetricalTextCentre: !1
        // label是否放在圆的正中间
        // colorScheme: ['#19c386', '#409eff'] // 预设sets的颜色
        // textFill: '#fff' // 文字填充颜色
      }).width(r.value).height(i.value);
      u.datum(e.data).call(f), u.selectAll("g path").style("fill", function(c, h) {
        return e.colors[h];
      }).style("fill-opacity", 0.7).style("stroke-opacity", 0).style("stroke-width", e.strokeWidth).style("stroke", e.strokeColor), u.selectAll("text").style("fill", e.textColor).style("font-size", "20px").style("font-weight", "700");
      const l = Ft("body .wrapper-venn").append("div").attr("class", "custom-venn-chart-tooltip");
      u.selectAll("g").on("mouseover", function(c, h) {
        Ag(u, c), s.value = e.colors[h], l.transition().duration(e.tooltipDelay).style("opacity", e.tooltipOpacity), l.text(`${e.legend[h]} ${c.label}`), Ft(this).transition("tooltip").duration(e.tooltipDelay).select("path").style("stroke-opacity", 1).style("fill-opacity", 1).style("fill", e.colors[h]);
      }).on("mousemove", function(c, h) {
        l.style("left", Qt.pageX + e.tooltipOffsetX + "px").style("top", Qt.pageY + e.tooltipOffsetY + "px");
      }).on("mouseout", function(c, h) {
        l.transition().duration(e.tooltipDelay).style("opacity", 0), Ft(this).transition("tooltip").duration(e.tooltipDelay).select("path").style("stroke-opacity", 0).style("fill-opacity", 0.7).style("fill", e.colors[h]);
    ...
    return zo(() => {
      const { ctx: u } = Do();
      o.value = u.$el, a(), window.addEventListener("resize", Xi(a, 500));
    }), qo(() => {
      window.removeEventListener("resize", Xi(a, 500));
    }), (u, f) => (Ho(), Xo("div", ox, ux));
  }
});
const cx = (t, n) => {
  ...
  for (const [r, i] of n)
    e[r] = i;
  return e;
}, dr = /* @__PURE__ */ cx(lx, [["__scopeId", "data-v-b9bc31d0"]]);
console.log(dr.name);
const hx = (t) => {
