(function(){"use strict";try{if(typeof document<"u"){var e=document.createElement("style");e.appendChild(document.createTextNode('.wrapper-venn[data-v-9e706cac]{width:100%;height:100%}.wrapper-venn[data-v-9e706cac] .custom-venn-chart-tooltip{position:absolute;min-height:32px;max-width:200px;font-size:16px;display:flex;align-items:center;text-align:left;padding:8px 16px 8px 36px;background:#fff;color:#606266;border:0;border-radius:8px;opacity:0;box-shadow:0 2px 8px #00000026;z-index:2333}.wrapper-venn[data-v-9e706cac] .custom-venn-chart-tooltip:before{content:"";width:10px;height:10px;position:absolute;left:16px;background-color:var(--d6c4a526);border-radius:50%;top:50%;transform:translateY(-50%)}')),document.head.appendChild(e)}}catch(t){console.error("vite-plugin-css-injected-by-js",t)}})();
...
const sx = (t) => (Bo("data-v-9e706cac"), t = t(), Vo(), t), ox = { class: "wrapper-venn" }, ax = /* @__PURE__ */ sx(() => /* @__PURE__ */ Uo("div", { id: "venn" }, null, -1)), ux = [
  ax
], fx = Bi({
  name: "VennChart"
}), lx = /* @__PURE__ */ Bi({
...
const cx = (t, n) => {
  ...
  for (const [r, i] of n)
    e[r] = i;
  return e;
}, Fe = /* @__PURE__ */ cx(lx, [["__scopeId", "data-v-9e706cac"]]);
Fe.install = (t) => {
