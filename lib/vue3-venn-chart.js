(function(){"use strict";try{if(typeof document<"u"){var e=document.createElement("style");e.appendChild(document.createTextNode('.wrapper-venn[data-v-6f6e8a37]{width:100%;height:100%}.wrapper-venn[data-v-6f6e8a37] .custom-venn-chart-tooltip{position:absolute;min-height:32px;max-width:200px;font-size:16px;display:flex;align-items:center;text-align:left;padding:8px 16px 8px 36px;background:#fff;color:#606266;border:0;border-radius:8px;opacity:0;box-shadow:0 2px 8px #00000026;z-index:2333}.wrapper-venn[data-v-6f6e8a37] .custom-venn-chart-tooltip:before{content:"";width:10px;height:10px;position:absolute;left:16px;background-color:var(--4daa8aa5);border-radius:50%;top:50%;transform:translateY(-50%)}')),document.head.appendChild(e)}}catch(t){console.error("vite-plugin-css-injected-by-js",t)}})();
...
var Ye = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, Me = new RegExp(Ye.source, "g");
function ll(t) {
  return function() {
    return t;
  };
...
function hl(t, n) {
  var e = Ye.lastIndex = Me.lastIndex = 0, r, i, s, o = -1, a = [], u = [];
  for (t = t + "", n = n + ""; (r = Ye.exec(t)) && (i = Me.exec(n)); )
...
var Lt, Ce, li, Mn;
function dl(t) {
  return t === "none" ? Ge : (Lt || (Lt = document.createElement("DIV"), Ce = document.documentElement, li = document.defaultView), Lt.style.transform = t, t = li.getComputedStyle(Ce.appendChild(Lt), null).getPropertyValue("transform"), Ce.removeChild(Lt), t = t.slice(7, -1).split(","), bs(+t[0], +t[1], +t[2], +t[3], +t[4], +t[5]));
}
function pl(t) {
  return t == null || (Mn || (Mn = document.createElementNS("http://www.w3.org/2000/svg", "g")), Mn.setAttribute("transform", t), !(t = Mn.transform.baseVal.consolidate())) ? Ge : (t = t.matrix, bs(t.a, t.b, t.c, t.d, t.e, t.f));
}
function Ns(t, n, e, r) {
  function i(f) {
    return f.length ? f.pop() + " " : "";
...
var E0 = no(C0, "px, ", "px)", "deg)"), k0 = no(R0, ", ", ")", ")"), er = "http://www.w3.org/1999/xhtml";
const Si = {
  svg: "http://www.w3.org/2000/svg",
  xhtml: er,
  xlink: "http://www.w3.org/1999/xlink",
...
const sx = (t) => (Bo("data-v-6f6e8a37"), t = t(), Vo(), t), ox = { class: "wrapper-venn" }, ax = /* @__PURE__ */ sx(() => /* @__PURE__ */ Uo("div", { id: "venn" }, null, -1)), ux = [
  ax
], fx = Bi({
  name: "VennChart"
}), lx = /* @__PURE__ */ Bi({
...
const cx = (t, n) => {
  ...
  for (const [r, i] of n)
    e[r] = i;
  return e;
}, Fe = /* @__PURE__ */ cx(lx, [["__scopeId", "data-v-6f6e8a37"]]);
Fe.install = (t) => {
